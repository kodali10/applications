//file:///Development/git/UI/JS/BudgetApp/index.html
	...
	return {
		...
		calculateBudget : function() {
			...
			if (data.totals.inc > 0) {
				data.percentage = Math
						.round((data.totals.exp / data.totals.inc) * 100);
			} else {
				data.percentage = -1;
			}
		},
...
var UIController = (function() {
	...
	return {
		// function reading elements from the UI
		getInput : function() {
			return {
				...
				value : parseFloat(document
						.querySelector(DOMstrings.inputValue).value)
			};
		...
		addListItem : function(obj, type) {
			...
			// Replace the placeholder text with some actual data from the obj
		...
		clearFeilds : function() {
			...
			feilds = document.querySelectorAll(DOMstrings.inputDescription
		...
		displayPercentages : function(percentages) {
			var fields = document
					.querySelectorAll(DOMstrings.expPercentageLabel);
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	// *********Function that holds events********//
	var setupEventListeners = function() {
		var DOM = UICtrl.getDOMstrings();

		// Event: add expense when click
		document.querySelector(DOM.inputBtn).addEventListener('click',
				ctrlAddItem);

		// Event: add expense when press enter
	...
	// *********Function that controls add items**********//
